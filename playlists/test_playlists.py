...
class PlaylistModelTestCase(TestCase):
    ...
    def create_videos(self):
        video_a = Video.objects.create(title='My title', video_id='abc11222')
        video_b = Video.objects.create(title='My title', video_id='abc124222')
    ...
    def test_playlist_video_through_model(self):
        ...
        self.assertEqual(v_qs, video_qs, playlist_obj_playlist_item_qs)
